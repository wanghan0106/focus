...
import com.roy.core.dao.Sort;
import com.roy.core.dao.Sorter;
import com.roy.core.dao.cond.Cond;
import com.roy.core.dao.helper.AliasHelper;
import com.roy.core.dao.helper.TypeAdapter;
import com.roy.core.exception.NonUniqueException;
...
public abstract class BaseDAOImpl<T> implements BaseDAO<T> {
	...
	private void prepare(Criteria criteria, Cond cond, Pager pager,
		...
		if (cnd != null) {
			TypeAdapter.adapt(entityClass,cond);
